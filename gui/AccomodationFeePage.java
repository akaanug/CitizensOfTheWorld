...
public class AccomodationFeePage extends javax.swing.JPanel implements Observer {
    ...
    * ordering the layout of AccomodationFeePage
    */
   ...
   /*
    * creating action listener for clicking the exit button 
    * for accomodation fee page
    */
   ...
   /*
    * updating the accomodation fee page by
    * considering the current location of players
    */
